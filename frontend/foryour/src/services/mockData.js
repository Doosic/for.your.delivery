export const productMocks = [
  {
    ...
    imageUrl: '',
    productUrl: 'https://search.shopping.naver.com/search/all?query=%EC%98%A4%EB%A6%AC%EC%A7%84%20%EC%BA%A3',
  ...
  },
  {
    ...
    imageUrl: '',
    productUrl: 'https://search.11st.co.kr/Search.tmall?kwd=%EB%A1%9C%EC%96%84%EC%BA%90%EB%8B%8C',
    providerCode: 'LOCAL_FALLBACK',
  },
  {
    ...
    imageUrl: '',
    productUrl: 'https://search.shopping.naver.com/search/all?query=%EA%B3%A0%EC%96%91%EC%9D%B4%20%EB%AA%A8%EB%9E%98',
    providerCode: 'LOCAL_FALLBACK',
  },
  {
...
export const briefingMock = {
  summary: '구매목록과 캘린더 연결 상태를 기준으로 오늘 살 상품과 기다릴 상품을 나눠 보여줍니다.',
  sections: [
    {
      title: '오늘 살 것',
      items: [
        { name: '세탁세제 리필 2.6L', note: '재고 D-3 · 가격 하락 감지', decision: 'BUY_NOW', label: 'BUY NOW' },
        { name: '고양이 모래 6L x2', note: '정기 구매 주기 도달', decision: 'BUY_NOW', label: 'BUY NOW' },
      ],
    },
    {
      title: '기다릴 것',
      items: [{ name: '고양이 사료 1.5kg', note: '다음 주 최저가 예상', decision: 'WAIT', label: 'WAIT' }],
    },
    {
      title: '일정 준비',
      items: [{ name: '캠핑 준비물', note: '캘린더 일정 기반 구매 마감 D-2', decision: 'PLAN', label: 'PLAN' }],
    },
  ],
}
...
export const agentMock = {
  ...
  decisions: [
    { name: '세탁세제 리필 2.6L', note: '재고 D-3 · 구매 권장', decision: 'BUY_NOW', label: 'BUY NOW' },
    { name: '고양이 사료 1.5kg', note: '다음 주 가격 하락 예상', decision: 'WAIT', label: 'WAIT' },
    { name: '물티슈 캡형 10팩', note: '재고 충분', decision: 'HOLD', label: 'HOLD' },
  ],
}
...
export const chatMock = {
  initialMessages: [
    { id: 1, role: 'user', text: '다음 주 캠핑 가는데 뭘 준비해야 해?' },
    {
      id: 2,
      role: 'assistant',
      text: '캠핑 일정을 기준으로 필요한 물품 후보를 찾았어요. 재고와 가격을 같이 확인해볼게요.',
      card: {
        title: '캠핑 준비물 추천',
        items: [
          { name: '부탄가스 4개입', decision: 'BUY_NOW', label: 'BUY NOW' },
          { name: '아이스팩 대형', decision: 'BUY_NOW', label: 'BUY NOW' },
          { name: '화로용 숯 3kg', decision: 'WAIT', label: 'WAIT' },
        ],
      },
    },
  ],
